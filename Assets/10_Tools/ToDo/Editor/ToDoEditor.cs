...
namespace Todo.Editor
{
    public class ToDoEditor : EditorWindow
    {
        ...
        private string _dataPath = @"Assets/10_Tools/ToDo/todo.asset";
        ...
        [MenuItem("Unfinished Games/Workflow/Todo-List")]
        ...
        private void LoadSettings()
        {
            ...
            _dataPath = EditorPrefs.GetString("data_path", @"Assets/10_Tools/ToDo/todo.asset");
        }
